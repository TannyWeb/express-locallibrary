    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            async.parallel({
                ...
                res.render('book_form', { title: 'Create Book Error',authors:results.authors, genres:results.genres, book: book, errors: errors.array() });
            });
            return;
        }
        else {
...
exports.book_update_get = function(req, res, next) {
    ...
    async.parallel({
        ...
        function(err, results) {
            ...
            res.render('book_form', {title: 'Book Update', book: results.book, authors:results.author, genres:results.genres})
